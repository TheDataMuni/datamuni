...
<section data-field="subtitle" class="p-summary">In 21st century the currency is not Data. It’s the Attention of People.</section>

<section data-field="body" class="e-content">

<section name="da10" class="section section--body section--first">
...
<figure name="2a0f" id="2a0f" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*rlnAH_rod_BKr3cP)

<figcaption class="imageCaption">[DEEP LEARNING RECOMMENDATION MODEL ARCHITECTURE ( DLRM )](https://arxiv.org/pdf/1906.00091.pdf)</figcaption>
...
<section name="15c4" class="section section--body">
...
<figure name="a7d9" id="a7d9" class="graf graf--figure graf--leading">![](https://cdn-images-1.medium.com/max/800/0*maDJlm5iWkQ3VdyT)</figure>

#### **LET’S START**

### **Model Workflow:**

<figure name="4906" id="4906" class="graf graf--figure graf-after--h3">![](https://cdn-images-1.medium.com/max/800/1*w1I1laI2NeeTEyUBiY9O4w.gif)

<figcaption class="imageCaption">DLRM Workflow</figcaption>
...
<section name="60c4" class="section section--body">
...
<figure name="8d3d" id="8d3d" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*3Ym44dctxGISlqGQ)</figure>
...
<figure name="edbb" id="edbb" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*Gs49CEBwLp6vYZsI)</figure>
...
<figure name="1667" id="1667" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*-8Q3H2GSzt1eTRG9)

<figcaption class="imageCaption">Factorization Matrix (FM) Equation</figcaption>

</figure>

<figure name="a544" id="a544" class="graf graf--figure graf-after--figure">![FM equation Workflow](https://cdn-images-1.medium.com/max/800/0*wt1NSe-hgtdJpxYj)</figure>
...
<figure name="8d96" id="8d96" class="graf graf--figure graf-after--li">![](https://cdn-images-1.medium.com/max/800/0*jI_TfRWbUw6oRGci)</figure>

<figure name="f7dc" id="f7dc" class="graf graf--figure graf--layoutOutsetLeft graf-after--figure">![](https://cdn-images-1.medium.com/max/600/0*tkFVjfYMiOKsEFce)

<figcaption class="imageCaption">Different orders of interaction matrices</figcaption>
...
<figure name="b1c1" id="b1c1" class="graf graf--figure graf--layoutOutsetLeft graf-after--p">![](https://cdn-images-1.medium.com/max/600/1*UyndHD1FdTHsAaeid2fn3Q.gif)</figure>
...
<figure name="7f8f" id="7f8f" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*XmYBFUWTrWaTACK8)</figure>
...
<figure name="4095" id="4095" class="graf graf--figure graf-after--h3">![](https://cdn-images-1.medium.com/max/800/1*KQpKYSBqt75H5JCZaFk1PA.png)</figure>
...
<figure name="3e0a" id="3e0a" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*O9r79-SKw1xsUbqf)

<figcaption class="imageCaption">Source : [https://arxiv.org/pdf/1906.03109.pdf](https://arxiv.org/pdf/1906.03109.pdf)</figcaption>
...
<figure name="921e" id="921e" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*DohG5SRSIqv0hYVF)</figure>
...
<section name="7ba3" class="section section--body section--last">
...
<figure name="4933" id="4933" class="graf graf--figure graf-after--h3">![Issues present with the DLRM Recommendation model : 1\. Compute Dominated 2\. Communication Dominated 3\. Memory Bandwidth Domi](https://cdn-images-1.medium.com/max/800/0*P7BuskcDAtf4AOGL)</figure>
...
<figure name="cc20" id="cc20" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*Gd4cvFMV6jjP5uaB)</figure>
...
<figure name="cf55" id="cf55" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*Dq8lje6ErCINAsth)

<figcaption class="imageCaption">**Butterfly Shuffle for the all-to-all (Personalized) Communication . Source :** [https://arxiv.org/pdf/1906.00091.pdf](https://arxiv.org/pdf/1906.00091.pdf)</figcaption>
...
<figure name="6fe4" id="6fe4" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*q675vLM0tOyNEjI6)</figure>
...
<figure name="5a9c" id="5a9c" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/1*3m-qL-IdvmPK0Z_bY9g5Gg.png)</figure>
...
<figure name="5f76" id="5f76" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*RK0j36Rsaj43QxUk)

<figcaption class="imageCaption">Hashing Trick</figcaption>
...
<figure name="d6b1" id="d6b1" class="graf graf--figure graf-after--li">![](https://cdn-images-1.medium.com/max/800/0*H_nsmRpcUxiI3U8g)

<figcaption class="imageCaption">Quotient-Remainder Trick</figcaption>
...
<figure name="d5de" id="d5de" class="graf graf--figure graf-after--h4">![](https://cdn-images-1.medium.com/max/800/0*z137OIgIHS8X3s34)

<figcaption class="imageCaption">Types of Complementary Partitions based on function</figcaption>
...
Source : [https://github.com/thumbe3/Distributed_Training_of_DLRM/blob/master/CS744_group10.pdf](https://github.com/thumbe3/Distributed_Training_of_DLRM/blob/master/CS744_group10.pdf)

<figure name="d361" id="d361" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*7_dPgZbjlTAxoAH0)</figure>
...
<figure name="c628" id="c628" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*KXFcMO8GtuQfYhUj)

<figcaption class="imageCaption">DISTRIBUTED DLRM</figcaption>
...
<figure name="a9ed" id="a9ed" class="graf graf--figure graf-after--p">![](https://cdn-images-1.medium.com/max/800/0*p7aMU0nxGffa0uDc)</figure>
...
<div name="45c9" id="45c9" class="graf graf--mixtapeEmbed graf-after--p graf--trailing">[**Open-sourcing FBGEMM for server-side inference - Facebook Engineering**  
_Facebook is open-sourcing FBGEMM, a high-performance kernel library, optimized for server-side inference. Unlike other…_engineering.fb.com](https://engineering.fb.com/ml-applications/fbgemm/ "https://engineering.fb.com/ml-applications/fbgemm/")[](https://engineering.fb.com/ml-applications/fbgemm/)</div>
...
By [Nishant Kumar](https://medium.com/@nishantkumar94) on [<time class="dt-published" datetime="2020-10-15T16:35:02.237Z">October 15, 2020</time>](https://medium.com/p/f38a95f47c2c).

[Canonical link](https://medium.com/@nishantkumar94/deep-learning-recommendation-models-dlrm-a-deep-dive-f38a95f47c2c)

Exported from [Medium](https://medium.com) on December 6, 2020.
